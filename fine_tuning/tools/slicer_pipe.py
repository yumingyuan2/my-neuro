...
ipt = os.path.join(os.path.dirname(script_dir),"output/uvr5/vocal.wav")
opt = os.path.join(os.path.dirname(script_dir),"output/sliced")
threshold = -34
min_length = 4000
hop_size = 8
min_interval = 300
...
if __name__ == '__main__':
    print("Starting slicer processing...")
    print(f"Input path: {ipt}")
    print(f"Output path: {opt}")
